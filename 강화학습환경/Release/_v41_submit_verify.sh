...
#   A는 TOPGUN_RULE=Rule_noevade.xml로 쟀다. 제출본은 그 env를 못 쓴다.
...
for OPP in AIP_jh2.dll ACE AIP_kwon.dll; do
  ...
  # (1) 실험 경로: AIP_v40.dll + TOPGUN_RULE=Rule_noevade.xml  (= A를 쟀던 방식)
  unset TOPGUN_MATCH TOPGUN_GEOM TOPGUN_ABLATE
  export TOPGUN_OWN_DLL="AIP_v40.dll" TOPGUN_RULE="./Rule_noevade.xml"
