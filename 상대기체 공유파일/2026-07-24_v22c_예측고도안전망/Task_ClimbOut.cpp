...
NodeStatus Action::Task_ClimbOut::tick()
{
	...
	// v22c: full throttle during recovery. ClimbOut never set throttle, so a low
	//  leftover value from LeadPredict (close-range decel 0.55~0.7) starved the climb
	//  and recovery failed (a cause of the seed11 crash).
	(*BB)->Throttle = 1.0f;
